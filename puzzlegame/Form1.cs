...
namespace puzzlegame
{
    public partial class Form1 : Form
    {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            Image orignal = Image.FromFile("F://saman1.jpg");
            cropImageToImages(orignal,270,270);
            addImageToButtons(images);
        }
        ...
        private void cropImageToImages(Image orignal , int w, int h)
        {
            Bitmap bitmap = new Bitmap(w,h);
            Graphics graphics = Graphics.FromImage(bitmap);
            graphics.DrawImage(orignal,0,0,w,h);
            graphics.Dispose();
            int movr = 0, movd = 0;
            int x = 0;
            for (x = 0;x < 8; x++){
        ...
        {
             MovedButton((Button)sender);
        }

        private void MovedButton(Button btn)
        {
